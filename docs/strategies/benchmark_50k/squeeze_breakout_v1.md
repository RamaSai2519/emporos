...
## squeeze_breakout_v1: FAILED

Out-of-sample: 167 trades, net -3176.33 (gross -950.83, charges 2225.50), win rate 22.2%, profit factor 0.105, compounded return -6.19%.

| check | actual | required | |
|---|---|---|---|
| net profit is positive | -3176.33 | > 0 | FAIL |
| enough trades to mean something | 167 | >= 150 | ok |
| profit factor | 0.105 | >= 1.2 | FAIL |
...
| still profitable without its best window | -2595.23 | > 0 | FAIL |
| still profitable if charges were twice as high | -5401.83 | > 0 | FAIL |

Classification: **REJECTED**

| gate | outcome | evidence |
|---|---|---|
| profit after costs is real | fail | net -3176.33, 95% interval -3808.17 to -2541.46, P(net > 0) 0.000 |
| profit survives adverse costs | unknown | net -3176.33 as run, -5730.98 under adverse costs |
...
| beats the luck of the search (Deflated Sharpe) | unknown | DSR 0.000 over 423 trials, 0.95 needed |
| beats the always-long baseline | fail | strategy net -3176.33, baseline -3062.66 |

Net P&L if costs were different (first-order re-pricing of the same trades):

- no_slippage: -2455.38
- benchmark: -3176.33
- slippage_plus5: -3897.28
- fees_x1_5: -4289.08
- fees_x2: -5401.83
- adverse: -5730.98
...
- 2026-01-30 to 2026-03-13: `tight_r20`
- 2026-03-13 to 2026-04-24: `tight_r15`
- 2026-04-24 to 2026-06-05: `loose_r15`
- 2026-06-05 to 2026-07-17: `loose_r30`
- 2026-07-17 to 2026-08-28: `tight_r20`
